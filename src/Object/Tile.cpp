...
Tile::Tile(float x, float y, Shader &shader, Renderer &renderer, Camera &camera, const std::string &texPath) :
    _object(nullptr)
{
    ...
    _object = new Object(buffer, indices, shader, renderer, camera, texPath);
    SetPos(x, y);
}
